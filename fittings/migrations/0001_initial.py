# Generated by Django 2.2.4 on 2019-11-25 03:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dogma_attributes', models.ManyToManyField(related_name='types', to='fittings.DogmaAttribute')),
                ('dogma_effects', models.ManyToManyField(related_name='types', to='fittings.DogmaEffect')),
            ],
            options={
                'default_permissions': (),
            },
